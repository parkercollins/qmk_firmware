...
/* QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |ESCAPE|   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |KEBABCASE|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_HYPR,          LT(_KEYPAD, KC_A), KC_S,      KC_D,   KC_F,   KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
...
layer_state_t layer_state_set_user(layer_state_t state) {
  return update_tri_layer_state(state, _LOWER, _KEYPAD, _ADJUST);
}
